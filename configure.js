...
const tokens = ['WICKRIO_BOT_NAME', 'DATABASE_ENCRYPTION_KEY', 'WHITELISTED_USERS', 'ROOM_ALIAS'];
  ...
  return new Promise((resolve, reject) => {
    var recursivePrompt = function() {
      ...
      if (token === 'WICKRIO_BOT_NAME' && process.env.WICKRIO_BOT_NAME !== undefined) {
        ...
        i++;
        return recursivePrompt();
      } else if (token === 'ROOM_ALIAS' && process.env.ROOM_ALIAS !== undefined) {
    ...
    for (var key in newObjectResult) {
      ...
      if (key === 'WICKRIO_BOT_NAME' && process.env.WICKRIO_BOT_NAME !== undefined) {
        ...
        continue;
      } else if (key === 'ROOM_ALIAS' && process.env.ROOM_ALIAS !== undefined) {
        var obj = {
